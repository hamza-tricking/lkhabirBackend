...
export default function CustomFolderAnimation() {
  return (
    <div>
      <div className={styles['folder']}>
        ...
        <div className={`${styles['page']} ${styles['page2']}`}>
          <div className="w-full h-full rounded flex items-center justify-center">
            <span className="text-black font-bold text-lg">عقود</span>
          </div>
        </div>
        <div className={`${styles['page']} ${styles['page3']}`}>
          <div className="w-full h-full rounded flex items-center justify-center">
            <span className="text-black font-bold text-lg">قانون</span>
          </div>
        </div>
      </div>
    </div>
